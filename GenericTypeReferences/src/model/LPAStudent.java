...
public class LPAStudent extends Student {
    ...
    public boolean matchFieldValue(String fieldName, String fieldValue) {
        ...
        return switch (fName) {
            case "STUDENTID" -> super.getName().equalsIgnoreCase(fieldValue);
            case "PERCENTCOMPLETE" -> percentComplete <= Double.parseDouble(fieldValue);
            case "NAME" -> super.getName().equalsIgnoreCase(fieldValue);
            case "COURSE" -> super.getCourse().equalsIgnoreCase(fieldValue);
