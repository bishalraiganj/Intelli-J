...
public class DicePlayer implements Player {
    ...
    public void rollDice()
    {
        ...
        List<Integer> newDice = new Random()
    ...
    {
        if((selected.length == 0 ) && selected[0].contains("ALL"))
        {
            currentDice.clear();
        }
        else
    ...
    public List<String> getItemList()
    {
        return scoreCard.entrySet()
                ...
                .collect(()->new ArrayList<>(),(ArrayList<String> e1, Map.Entry<ScoredItem,Integer> e2)->e1.add(e2.getKey().name()),(e3,e4)->e3.addAll(e4));
    }
    ...
    private boolean scoreDice()
    {
        ...
        String userInput  = GameConsole.getUserInput(prompt  + "--> ").toUpperCase();
        if(userInput.isBlank())
        {
            return false;
        }
