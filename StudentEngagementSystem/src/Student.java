...
//        int lastIndexRandomNumber = random.nextInt(courses.length);
//        Course[] coursesRandom = new Course[lastIndexRandomNumber+1];
//        for(int i=0;i<=lastIndexRandomNumber;i++)
//        {
//            coursesRandom[i] = courses[i];
//        }
